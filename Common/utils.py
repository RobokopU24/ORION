...
class NodeNormUtils:
    ...
    def normalize_node_data(self, node_list: list, block_size: int = 5000) -> list:
        ...
        while True:
            if start_index < last_index:
                ...
                # get the data
                resp: requests.models.Response = requests.post('https://nodenorm.ci.transltr.io/1.1/get_normalized_nodes', json={'curies': data_chunk})
    ...
    def get_current_node_norm_version():
        ...
        node_norm_openapi_url = 'https://nodenorm.ci.transltr.io/1.1/openapi.json'
