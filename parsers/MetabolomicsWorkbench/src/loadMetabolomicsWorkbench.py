...
class MetabolomicsWorkbenchLoader(SourceDataLoader):
    ...
    def __init__(self, test_mode: bool = False, source_data_dir: str = None):
        ...
        # with open('/home/jdr0887/workspace/github/RobokopU24/ORION/cfde-config.yml', 'r') as file:
...
if __name__ == '__main__':
    source_data_dir = str(os.path.join("/media/jdr0887/backup/home/jdr0887/ORION_root/ORION_storage", "MetabolomicsWorkbench", "2024-05-08"))
