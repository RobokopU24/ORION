...
if __name__ == '__main__':
    ...
    # command line should be like: python get_uniref_taxon_targets.py -d /projects/stars/ORION/UniRef_data -f uniref50,uniref90,uniref100
    ...
    # uniref_data_dir: str = 'E:/ORION/UniRef_data'
    # uniref_data_dir = '/projects/stars/ORION/UniRef_data'
    # uniref_data_dir = '/e/ORION/UniRef_data'
    ...
    for file in in_file_list:
        ...
        # grep -F -b -f "/e/ORION/UniRef_data/taxon_list.txt" "/e/ORION/UniRef_data/uniref100.xml" >> "/e/ORION/UniRef_data/uniref100_taxon_file_indexes.txt"
        # grep -F -b -f "/e/ORION/UniRef_data/taxon_list.txt" "/e/ORION/UniRef_data/uniref90.xml" >> "/e/ORION/UniRef_data/uniref90_taxon_file_indexes.txt"
        # grep -F -b -f "/e/ORION/UniRef_data/taxon_list.txt" "/e/ORION/UniRef_data/uniref50.xml" >> "/e/ORION/UniRef_data/uniref50_taxon_file_indexes.txt"
